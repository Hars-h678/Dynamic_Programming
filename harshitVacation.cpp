//                                         original question is basically C-vacation
/**
 * Problem Statement
...
int main(){
    ...
    int a,b,c;
    cout<<"Enter the activitie's bonus point";
    cin>>a>>b>>c;
    // [i] means number of days [j] which activity u chooese a,b,c points corresponding to each j
    dp[0][0] = a;
    dp[0][1] =b;
    dp[0][2] =c;
    for(int i=1;i<n;i++){
